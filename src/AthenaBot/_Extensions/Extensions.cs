...
public static class Extensions
{
    ...
    public static string RealSummary(
        ...
        string prefix)
    {
        string description = strings.GetCommandStrings(cmd.Summary, culture).Desc;
    ...
    public static string[] RealRemarksArr(
        ...
        string prefix)
    {
        string[] args = strings.GetCommandStrings(cmd.Summary, culture).Args;
    ...
    public static IMessage DeleteAfter(this IUserMessage msg, float seconds)
    {
        Task.Run(async () =>
        {
