#nullable disable
using AthenaBot.Modules.AthenaExpressions;

namespace AthenaBot.Common.TypeReaders;

public sealed class CommandTypeReader : AthenaTypeReader<CommandInfo>
{
...
public sealed class CommandOrExprTypeReader : AthenaTypeReader<CommandOrExprInfo>
{
    private readonly CommandService _cmds;
    private readonly CommandHandler _commandHandler;
    private readonly AthenaExpressionsService _exprs;

    public CommandOrExprTypeReader(CommandService cmds, AthenaExpressionsService exprs, CommandHandler commandHandler)
    {
        _cmds = cmds;
        _exprs = exprs;
