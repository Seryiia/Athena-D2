...
using AthenaBot.Modules.StreamNotification;

namespace AthenaBot.Modules.Searches;

public partial class StreamNotifs : AthenaModule<INService>
{
    [Group]
    public partial class StreamNotificationCommands : AthenaModule<StreamNotificationService>
    {
        ...
        [RequireUserPermission(GuildPerm.ManageMessages)]
