...
[Name("Expressions")]
public partial class AthenaExpressions : AthenaModule<AthenaExpressionsService>
{
    public enum All
    {
        All
    ...
    public AthenaExpressions(IBotCredentials creds, IHttpClientFactory clientFactory)
    {
        _creds = creds;
